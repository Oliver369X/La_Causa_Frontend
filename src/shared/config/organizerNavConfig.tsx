...
export const ORGANIZER_NAV_SECTIONS: OrganizerNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/manuales", icon: FileText, label: "Manuales", permissionAction: "viewEvents" },
    ],
  },
  {
    key: "gamificacion",
    ...
    items: [
      ...
      { href: "/dashboard/gamification-lab", icon: Sparkles, label: "Lab visual", superAdminOnly: true },
    ],
  },
  {
    key: "inteligencia",
    ...
    items: [
      ...
      { href: "/dashboard/ml-lab", icon: Wrench, label: "ML Lab", superAdminOnly: true },
